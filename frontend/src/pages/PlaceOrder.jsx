...
const PlaceOrder = () => {
  ...
  return (
    ...
    <div className='flex flex-col gap-4 w-full sm:max-w-[480px]'>
     ...
     <input className='border border-gray-300 rounded py-1.5 px-3.5 w-full' type="text" placeholder='Street No'/>
     <div className='flex gap-3'>
...
<p className='text-gray-500 text-sm font-medium mx-4'>CLICK</p>
</div>
